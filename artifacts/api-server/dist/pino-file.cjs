  ...
  "../../node_modules/.pnpm/pino@9.14.0/node_modules/pino/pino.js"(exports2, module2) {
    function pinoBundlerAbsolutePath(p) {
      try {
        ...
        const outputDir = "D:\\Downloads\\project\\artifacts\\api-server\\dist";
    ...
    globalThis.__bundlerPathsOverrides = { ...globalThis.__bundlerPathsOverrides || {}, "thread-stream-worker": pinoBundlerAbsolutePath("./thread-stream-worker.cjs"), "pino-worker": pinoBundlerAbsolutePath("./pino-worker.cjs"), "pino/file": pinoBundlerAbsolutePath("./pino-file.cjs") };
